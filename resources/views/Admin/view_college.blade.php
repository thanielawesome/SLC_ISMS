      ...
      <div class="form-group">
        ...
        <div class="row" required>
            <div class="col">
                ...
                <label>{{$student_info->department}}</label>
            </div>
            <div class="col">
                <label><strong>Course:</strong> </label>
                <label>{{$student_info->course}}</label>
            </div>
            <div class="col">
                <label><strong>Year:</strong> </label>
                <label>{{$student_info->year}}</label>
            </div>
        </div> <br>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="post" action="update_student_c">
                        ...
                        <label><strong>Department:</strong> </label>
                        <input class="form-control" name="department" value="{{$student_info->department}}"><br>

                        <label><strong>Course:</strong> </label>
                        <input class="form-control" name="course" value="{{$student_info->course}}"><br>
                  
                        <label><strong>Year:</strong> </label>
                        <input class="form-control" name="year" value="{{$student_info->year}}"><br>
            ...
            <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="post" action="delete_student_c">
